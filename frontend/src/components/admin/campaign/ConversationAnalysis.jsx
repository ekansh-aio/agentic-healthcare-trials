...
export default function ConversationAnalysis({ analysis, sessionId, onReanalyze, loading }) {
  ...
  const eligColor     = eligible === "eligible" ? "#16a34a" : eligible === "not_eligible" ? "#dc2626" : "var(--color-sidebar-text)";
  const eligBg        = eligible === "eligible" ? "rgba(34,197,94,0.1)" : eligible === "not_eligible" ? "rgba(239,68,68,0.08)" : "rgba(107,114,128,0.08)";
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <span style={{
          ...
          {eligible === "eligible" ? "Eligible" : eligible === "not_eligible" ? "Not Eligible" : "Unknown Eligibility"}
        </span>
        {analysis.channel && (
